...
def activity(driver, approve_name, personnel):
    approve_list = {'活动审核': '1', '优惠卷审核': '2', '养护审核': '3', '购进退货审核':'4', '损益申请审核':'5', '仓库购进退货单审核':'6', '门店退仓审核':'7', '首营资料审核':'8', '配送申请审核':'9', '采购计划审核':'10',}
    ...
    driver.find_element_by_css_selector("div.el-table__fixed-right > div:nth-child(2) > table:nth-child(1) > tbody:nth-child(2) > tr:nth-child(1) > td:nth-child(5) > div:nth-child(1) > button:nth-child(2) > span:nth-child(1)").click()
    time.sleep(2)
